      ...
      <div style="margin-right: -30px;" class="col-1">
        ...
        <label for="darkmode-toggle" class="darkmode-toggle-label">
          <svg class="moon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <g id="SVGRepo_iconCarrier">
              ...
              <path
                ...
                :fill="isDarkMode ? '#e6b802' : '#bbb'"></path>
            </g>
          </svg>
          <svg class="sun" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
            ...
            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
            <g id="SVGRepo_iconCarrier">
              <path d="M8 22H16" :stroke="isDarkMode ? '#555' : '#fff'" stroke-width="1.5" stroke-linecap="round"
                stroke-linejoin="round"></path>
              <path d="M5 19H19" :stroke="isDarkMode ? '#555' : '#fff'" stroke-width="1.5" stroke-linecap="round"
                stroke-linejoin="round"></path>
              <path d="M2 16H22" :stroke="isDarkMode ? '#555' : '#fff'" stroke-width="1.5" stroke-linecap="round"
                stroke-linejoin="round"></path>
              <path
                ...
                :stroke="isDarkMode ? '#555' : '#fff'" stroke-width="1.5" stroke-linecap="round"></path>
              <path d="M12 2V3" :stroke="isDarkMode ? '#555' : '#fff'" stroke-width="1.5" stroke-linecap="round">
              </path>
              <path d="M22 12L21 12" :stroke="isDarkMode ? '#555' : '#fff'" stroke-width="1.5" stroke-linecap="round">
              </path>
              <path d="M3 12L2 12" :stroke="isDarkMode ? '#555' : '#fff'" stroke-width="1.5" stroke-linecap="round">
              </path>
              <path d="M19.0708 4.92969L18.678 5.32252" :stroke="isDarkMode ? '#555' : '#fff'" stroke-width="1.5"
                stroke-linecap="round"></path>
              <path d="M5.32178 5.32227L4.92894 4.92943" :stroke="isDarkMode ? '#555' : '#fff'" stroke-width="1.5"
                stroke-linecap="round"></path>
            </g>
          </svg>
        </label>
