<template>
    <div class="floating-contacts">
      ...
      <!-- Opções de contato -->
      <div v-if="showContacts" class="contact-options" @mouseleave="startTimeout">
        <a 
          href="https://linkedin.com/in/diluan-matos" 
          target="_blank"
          class="contact-option"
          @mouseover="showContactImage('linkedin')"
        ...
        <a 
          href="mailto:diluan135@gmail.com"
          class="contact-option"
          @mouseover="showContactImage('email')"
          @mouseleave="resetContactImage"
        >
        ...
        <a 
          href="https://wa.me/+5542984049847"
          target="_blank"
          class="contact-option"
          @mouseover="showContactImage('whatsapp')"
          @mouseleave="resetContactImage"
        >
        ...
        <a 
          href="https://github.com/diluan135"
          target="_blank"
          class="contact-option"
          @mouseover="showContactImage('github')"
          @mouseleave="resetContactImage"
        >
        ...
        <a 
          href="https://instagram.com/diluanmatos"
          target="_blank"
          class="contact-option"
          @mouseover="showContactImage('instagram')"
          @mouseleave="resetContactImage"
        >
  ...
  .contact-options {
    position: absolute;
    top: -350px; /* Ajuste para as opções ficarem acima da bolinha */
    right: 0;
    display: flex;
  ...
  .contact-option img {
    width: 40px;
    height: 40px;
    margin-left: 8px; /* O ícone aparece à direita do nome */
  }
  ...
  .contact-name {
    ...
    font-size: 1em;
    color: white;
    display: none; /* O nome da rede social começa oculto */
  }
  
  .contact-option:hover .contact-name {
    display: inline-block; /* O nome aparece ao passar o mouse */
  }
